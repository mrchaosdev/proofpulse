    ...
    <div className="page-region stack">
      ...
      <section className="stack">
        ...
        <ul className="boundary-list">
          <li>
            ...
            participant flows, from −100 to +100. It is not a price forecast and
            not a probability.
          </li>
          <li>
      ...
      <section className="stack">
        ...
        <p>
          ...
          <span className="identifier">tanh(net flow / scale)</span>, weighted,
          and averaged. The scale is{" "}
          ...
          replaces it. Weights of missing cohorts are removed and the remainder
          renormalized, so a missing cohort is never counted as zero.
        </p>
      ...
      <section className="stack">
        ...
        <p>
          A historical fixture caps Confidence at {FIXTURE_CONFIDENCE_CAP}, so a
          deterministic demo can never present itself as a live result. When no
          required dataset returns usable records, the quality component
          contributes nothing rather than a residual.
        </p>
      </section>

      <section className="stack">
        <h2>Coordination risk</h2>
        <div className="table-scroll">
          <table className="data-table">
            <caption className="visually-hidden">
        ...
        <p>
          ...
          <strong>not assessed</strong>, never zero. A concentration-only result
          is marked preliminary and capped at {PRELIMINARY_SCORE_CAP}. Timing
          concentration currently contributes nothing, because consistent
          source-time coverage has not been verified.
        </p>
      </section>
      ...
      <section className="stack">
        ...
        <ul className="boundary-list">
          ...
          <li>
            ...
            investigation makes four calls before any optional wallet expansion.
          </li>
        </ul>
      </section>
    </div>
